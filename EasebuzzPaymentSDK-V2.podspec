#
#  Be sure to run `pod spec lint EasebuzzPaymentSDK-V2.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  s.source = { :git => 'https://easebuzz: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@github.com/easebuzz/paywitheasebuzz-ios-v2-lib', :tag => ‘1.1.1’ }
